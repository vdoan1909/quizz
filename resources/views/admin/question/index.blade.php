        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">List Questions</h5>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr class="text-start">
                                    <td>{{ $item->id }}</td>
                                    <td>{{ \Str::limit($item->name, 200) }}</td>
                                    <td>{{ \Str::limit($item->option_a, 90) }}</td>
                                    <td>{{ \Str::limit($item->option_b, 90) }}</td>
                                    <td>{{ \Str::limit($item->option_c, 90) }}</td>
                                    <td>{{ \Str::limit($item->option_d, 90) }}</td>
                                    <td>{{ \Str::limit($item->correct_answer, 90) }}</td>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="{{ Route('admin.questions.edit', $item->id) }}"
